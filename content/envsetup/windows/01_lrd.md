---
title: Create a Local Root Directory
label: envsetup-windows-lrd
---

You will create a directory that you will use as your **local root directory** (LRD) for this course. This directory can be anywhere on your computer. We will refer to your **local root directory** through the remainder of the semester.
